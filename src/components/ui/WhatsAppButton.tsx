...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed right-4 bottom-4 z-[120] flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] shadow-lg transition-transform hover:scale-105 sm:right-5 sm:bottom-5 sm:h-14 sm:w-14"
    >
      <svg viewBox="0 0 32 32" className="h-6 w-6 fill-white sm:h-7 sm:w-7" aria-hidden="true">
